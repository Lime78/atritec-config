export const webApi = [
    {
    "webInfo": {
    "Project name": "User_enters | defaults to sessionName from session.json i.e. 2024-07-10_10-10-11",
    "Vehicle": "Y1",
    "Session name": "2024-07-10_10-10-11",
    "Path nas": "//192.168.1.6/Mobile_mapping",
